...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            model_name='kyc',
            name='gender',
            field=models.CharField(choices=[('Bank Transfer', 'Bank Transfer'), ('Cash Deposit', 'Cash Deposit'), ('Mobile Money', 'Mobile Money'), ('Other', 'Other')], max_length=40),
        ),
        migrations.AlterField(
            model_name='kyc',
            name='marrital_status',
            field=models.CharField(choices=[('Bank', 'Bank'), ('Wallet', 'Wallet'), ('Memo Name', 'Memo Name'), ('Other', 'Other')], max_length=40),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('marrital_status', models.CharField(choices=[('Bank', 'Bank'), ('Wallet', 'Wallet'), ('Memo Name', 'Memo Name'), ('Other', 'Other')], max_length=40)),
                ('gender', models.CharField(choices=[('Bank Transfer', 'Bank Transfer'), ('Cash Deposit', 'Cash Deposit'), ('Mobile Money', 'Mobile Money'), ('Other', 'Other')], max_length=40)),
